  ...
  return (
    <div className="max-w-xl rounded-md overflow-hidden shadow-2xl m-4 border-2 border-gray-300 transition-transform duration-300 ease-in-out transform hover:scale-105 bg-white">
      ...
      <div className="px-6 py-4">
        ...
        <button className="absolute bottom-4 right-4 px-6 py-2 border-2 border-black text-black bg-transparent text-sm md:text-base rounded-md transition duration-300 ease-in-out hover:bg-black hover:text-white active:bg-gray-900 active:text-white" onClick={() => handleShow(cafe.id)}>
          Mostrar más
        </button>
      </div>
    </div>
