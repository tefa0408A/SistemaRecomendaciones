...
public class Constants {
    ...
    public static final String ENPOINTS_RESTAURANT_DISTRICT = "/api/restaurant/v1/distrito/{distrito}";
    public static final String ENPOINTS_PHOTO = "/api/photo/v1/{restauranteId}";
}
